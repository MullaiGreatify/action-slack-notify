...
public class SchoolOnboardPage extends BaseClass {
	...
	public void setConfirmLoginBtn(WebElement confirmLoginBtn) {
		this.confirmLoginBtn = confirmLoginBtn;
	}
	...
	public WebElement getOldPassTxt() {
		return oldPassTxt;
	}

	public void setOldPassTxt(WebElement oldPassTxt) {
		this.oldPassTxt = oldPassTxt;
	}

	public WebElement getNewPassTxt() {
		return newPassTxt;
	}

	public void setNewPassTxt(WebElement newPassTxt) {
	...
	public void setConfirmPassTxt(WebElement confirmPassTxt) {
...
//		enterUrl(getPropertyFileValue("superadminProd"));
...
//		EnterInTextbox(getTxtUserID(), getPropertyFileValue("superadminProdUsername"));
		
		
		EnterInTextbox(getTxtUserPassword(), getPropertyFileValue("superadminpassword"));
//		EnterInTextbox(getTxtUserPassword(), getPropertyFileValue("superadminProdPassword"));
...
//		enterUrl(schoolAdminURL);
		enterUrl("https://abcd086.heycampus.in/school/login");
//		enterUrl("https://abcd086.heycampus.app/school/login");

		explicitWaitClickable(10, getUserID());
		clickWithRetry(getUserID());
		
//		EnterInTextbox(getUserID(), schoolID);
		EnterInTextbox(getUserID(), "HCSCHOOL0465");
//		EnterInTextbox(getUserID(), "HCSCHOOL0148");

		explicitWaitClickable(10, getUserPassword());
		clickWithRetry(getUserPassword());
		
//		EnterInTextbox(getUserPassword(), schoolPassword);
		EnterInTextbox(getUserPassword(), "Mullai1@");
	...
	public void UpdatePassword() {
		...
		/**
		 * Update Password in the Create Password Page
		 */

		explicitWaitClickable(10, getOldPassTxt());
		clickWithRetry(getOldPassTxt());
		EnterInTextbox(getOldPassTxt(), schoolPassword);

		explicitWaitClickable(10, getNewPassTxt());
		clickWithRetry(getNewPassTxt());
		EnterInTextbox(getNewPassTxt(), "Mullai1@");

		explicitWaitClickable(10, getConfirmPassTxt());
		clickWithMultipleRetry(getConfirmPassTxt(), 10, 500);
		EnterInTextbox(getConfirmPassTxt(), "Mullai1@");

		explicitWaitClickable(10, getConfirmBtn());
		clickWithMultipleRetry(getConfirmBtn(), 10, 500);

		explicitWaitClickable(10, getConfirmLoginBtn());
		clickWithMultipleRetry(getConfirmLoginBtn(), 10, 500);
	}
...
//		fileInput1.sendKeys(uploadFile1.getAbsolutePath());
		...
		WebElement fileInput1 = labelElement
				.findElement(By.xpath("//input[@type='file' and @id='csv_file_sub_upload']"));
...
//		EnterRobot(robot);
		...
		WebElement fileInput2 = labelElement1
				.findElement(By.xpath("//input[@type='file'and @id='csv_file_teacher_upload']"));
...
//		WebElement fileInput3 = labelElement2.findElement(By.id("csv_file_class_upload"));
		...
		WebElement fileInput3 = labelElement2
				.findElement(By.xpath("//input[@type='file' and @id='csv_file_class_upload']"));
...
//		WebElement fileInput4 = labelElement3.findElement(By.id("csv_file_student_upload"));
		WebElement fileInput4 = labelElement3
				.findElement(By.xpath("//input[@type='file' and @id='csv_file_student_upload']"));
